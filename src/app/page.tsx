    ...
    return (
        <section className={styles["home"]}>
            <div className={styles["home__main"]}>
                <NextLogo />
                <h1 className={styles["home__main__title"]}>Next-SSR-Web-Template</h1>
                <p className={styles["home__main__desc"]}>一个基于 Next.js 的服务端渲染(SSR)模版，助力高效开发现代 Web 应用。</p>

                <div className={styles["home__main__actions"]}>
